...
local Window = Library.CreateLib("Basically FNF: Remix", "Midnight")

local speed = Window:NewTab("AutoPlayer")


local rs = speed:NewSection("AutoPlayer")



rs:NewToggle("AutoPlayer", "JustAutoPlayer", function(state)
    if state then
...
rs:NewKeybind("ToggleUi", "KeybindInfo", Enum.KeyCode.RightShift, function()
	Library:ToggleUI()
end)
